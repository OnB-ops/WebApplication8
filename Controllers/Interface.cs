...
namespace WebApplication8.Controllers
{
    ...
    [Serializable]
    internal class IncorrectLabDataException : Exception
    {
        ...
        public IncorrectLabDataException(string message, Exception innerException) : base(message, innerException)
        {
        }

        protected IncorrectLabDataException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
    }
}
